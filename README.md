...
Note: Repositories are private due to academic/institutional policies.
...
- `ESP32 and C++`
- Hardware-software integration focused on sensor data & power efficiency.

🧺 Laví | Laundry Service Marketplace
- `Bun and React Native`
- Streamlined scheduling and management for laundry businesses.
